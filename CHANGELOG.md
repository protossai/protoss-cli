...
- Gate draft releases on native Linux, macOS, and Windows tests of the exact packaged archives.
...
- Add bundled and local conformance-suite execution.
- Add versioned JSON output and stable process exit classes.
- Add cross-platform release archives, SHA-256 checksums, provenance attestations, and install
  documentation.
